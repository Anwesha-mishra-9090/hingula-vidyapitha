...
import { Landmark, Target, Eye, Award, Users, BookOpen, Shield, Leaf, Calendar, MapPin, Phone, Mail } from "lucide-react";
...
function AboutPage() {
  const milestones = [
    { year: 1992, title: "School Established", description: "Founded under Board of Secondary Education, Odisha", icon: Calendar },
    { year: 2008, title: "Science Laboratory", description: "Dedicated science lab with equipment", icon: BookOpen },
    { year: 2012, title: "NCC Unit", description: "Affiliated to 4(O) CTC NCC, Cuttack", icon: Shield },
    { year: 2018, title: "Eco Club", description: "Environmental awareness initiatives launched", icon: Leaf },
    { year: 2022, title: "Best NCC Unit", description: "Awarded Best NCC Unit in Jajpur District", icon: Award },
    { year: 2024, title: "Smart Classroom", description: "Digital learning facilities installed", icon: Users },
  ];
    ...
    <div className="container py-8 space-y-12">
      ...
      >
        <div className="relative z-10">
          ...
          <p className="text-white/90 text-lg md:text-xl mt-4 max-w-3xl italic">
            "{SCHOOL.motto}"
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              fostering responsible citizens who contribute meaningfully to society while 
              preserving our cultural heritage and embracing modern values.
            </p>
          </motion.div>
      ...
      <section>
        ...
        <div className="rounded-xl border border-border bg-card p-6 md:p-8">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Over the past three decades, the school has consistently achieved 100% pass rate in 
            the BSE Odisha High School Certificate Examination. The institution has expanded its 
            facilities to include a science laboratory, NCC unit, Eco Club, Energy Club, and 
            smart classroom facilities, continuously evolving to meet modern educational needs 
            while maintaining its core values of discipline, dedication, and service.
          </p>
        </div>
      </section>
      ...
      {/* Milestones Timeline */}
      <section>
        <h2 className="font-display text-2xl md:text-3xl font-bold mb-6 text-center">Key Milestones</h2>
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:8260191483" className="text-muted-foreground hover:text-primary transition">
                  8260191483 (Head Master)
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-muted-foreground" />
                <a href="mailto:hingulavidyapitha@gmail.com" className="text-muted-foreground hover:text-primary transition">

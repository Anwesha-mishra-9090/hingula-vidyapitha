...
const subjects = [
  {
    icon: Languages,
    name: "Odia / Hindi / English",
    desc: "Three-language formula per BSE Odisha curriculum.",
  },
  {
    icon: Calculator,
    name: "Mathematics",
    desc: "Algebra, geometry, trigonometry, statistics — Class VIII to X.",
  },
  {
    icon: Beaker,
    name: "Science",
    desc: "Physics, chemistry, biology with practical laboratory sessions.",
  },
  {
    icon: Globe2,
    name: "Social Science",
    desc: "History, geography, civics, economics — preparing informed citizens.",
  },
  {
    icon: BookOpen,
    name: "Sanskrit",
    desc: "Classical Sanskrit as third language under TGT specialised faculty.",
  },
  {
    icon: Palette,
    name: "Work Experience & Art",
    desc: "Creative expression and vocational basics across all classes.",
  },
];
    ...
    <div className="container py-8 space-y-10">
      <header>
        ...
        <p className="text-muted-foreground mt-3 max-w-2xl">
          Hingula Vidya Pitha offers Classes VIII to X under the Board of Secondary Education,
          Odisha syllabus — with a balanced emphasis on language, science, mathematics, and civics
          awareness.
        </p>
      </header>
          ...
          {[
            {
              ...
              focus: "Foundation modules · Unit tests",
            },
            {
              term: "Term II",
              dates: "October - December",
              focus: "Half-yearly examination · Projects",
            },
            {
              term: "Term III",
              dates: "January - March",
              focus: "Revision · Annual / Board examinations",
            },
          ].map((t) => (

  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <img src={currentImage.src} alt={currentImage.title} className="max-h-[80vh] max-w-[80vw] object-contain rounded-lg" />
          <div className="mt-4 text-center text-white">
            <p className="text-sm">{currentImage.title}</p>
            {currentImage.category && <p className="text-xs text-white/60">{currentImage.category}</p>}
          </div>
        </motion.div>

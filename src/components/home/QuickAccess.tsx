...
import { GraduationCap, BookOpen, Calendar, Phone, Users, Trophy, Bell, Shield } from 'lucide-react';

const quickLinks = [
  { icon: GraduationCap, label: 'Admissions', href: '/academics', color: 'bg-emerald-500/10 text-emerald-600' },

...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    role: "Head Master",
    content: "Hingula Vidya Pitha has stood in Bhotaka for thirty four years, quietly shaping generations of students. We believe a school's measure is not in its walls but in the character of the children who walk through them.",
  },
  {
    id: 2,
    name: "Parent of Class X Student",
    role: "Parent",
    content: "The dedicated teachers and disciplined environment have transformed my child's academic journey.",
  },
  {
    id: 3,
